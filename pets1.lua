...
function FindPetToPlaceOnFarm()
    print("A")
    local a=player:FindFirstChildOfClass("Backpack")
    print("B")
    if not a then
        return nil
    end
    ...
    for _,b in ipairs(a:GetChildren()) do
        print("D")
        if b:IsA("Tool") and b:GetAttribute("b")=="l" and string.find(b.Name,"Dilophosaurus") then
            print(b:GetAttribute("PET_UUID"))
            return b:GetAttribute("PET_UUID")
        end
    end
    print("F")
    return nil
