...
function RayfieldLibrary:CreateWindow(Settings)
    ...
    function Window:CreateTab(Name, Image, Ext)
        ...
        function Tab:CreateDropdown(DropdownSettings)
            ...
            -- Perbaikan: Hapus search input yang sudah ada jika ada
            local existingSearch = Dropdown.List:FindFirstChild("SearchInput")
            if existingSearch then
                existingSearch:Destroy()
            end

            -- Tambahkan search input dengan posisi dan ukuran yang benar
            ...
            SearchInput.Visible = true -- Pastikan terlihat
            ...
            -- Pastikan SearchInput adalah child pertama dari List
            SearchInput.Parent = Dropdown.List
            
            -- Atur ulang posisi semua option untuk memberi ruang pada search input
            local function updateOptionPositions()
                local yOffset = 35 -- Offset untuk memberi ruang pada search input
                for i, option in ipairs(Dropdown.List:GetChildren()) do
                    if option.ClassName == "Frame" and option.Name ~= "Placeholder" and option.Name ~= "SearchInput" then
                        option.Position = UDim2.new(0, 5, 0, yOffset)
                        yOffset = yOffset + 30 -- Sesuaikan dengan tinggi option
                    end
                end
                -- Sesuaikan ukuran canvas list
                Dropdown.List.CanvasSize = UDim2.new(0, 0, 0, yOffset)
            end
            ...
            SearchInput.Focused:Connect(function()
                SearchInput.Text = "" -- Clear text ketika difokuskan
            end)
            ...
            SearchInput.FocusLost:Connect(function(enterPressed)
                if enterPressed then
                    ...
                    if #visibleOptions > 0 then
                        ...
                        SearchInput.Text = "" -- Reset pencarian setelah memilih
                    end
                end
            end)
            ...
            for _, ununusedoption in ipairs(Dropdown.List:GetChildren()) do
                if ununusedoption.ClassName == "Frame" and ununusedoption.Name ~= "Placeholder" and ununusedoption.Name ~= "SearchInput" then
            ...
            Dropdown.Interact.MouseButton1Click:Connect(function()
                ...
                if Dropdown.List.Visible then
                    ...
                    task.wait(0.35)
                    Dropdown.List.Visible = false
                    SearchInput.Text = "" -- Reset pencarian ketika dropdown ditutup
                    Debounce = false
                else
                    ...
                    -- Fokuskan ke search input ketika dropdown dibuka
                    task.wait(0.1)
            ...
            local function SetDropdownOptions()
                for _, Option in ipairs(DropdownSettings.Options) do
                    ...
                    DropdownOption.Interact.MouseButton1Click:Connect(function()
                        ...
                        for _, droption in ipairs(Dropdown.List:GetChildren()) do
                            if droption.ClassName == "Frame" and droption.Name ~= "Placeholder" and droption.Name ~= "SearchInput" and not table.find(DropdownSettings.CurrentOption, droption.Name) then
                ...
                updateOptionPositions() -- Update posisi options setelah ditambahkan
            end
            SetDropdownOptions()
